...
portion_independent = tf.keras.models.load_model('ml models/portion_independent.h5')
image_model = tf.keras.models.load_model('ml models/model.h5')

classes = pd.read_json('ml models/class_encoding.json')
...
if __name__ == '__main__':
    app.run(debug=True, port=5001)  # Ensure this port matches your frontend calls
